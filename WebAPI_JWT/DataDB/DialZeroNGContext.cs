...
{
    public partial class DialZeroNGContext : DbContext
    {
        ...
        public virtual DbSet<SoftwarePermission> SoftwarePermissions { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SoftwarePermission>(entity =>
            {
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasMany(d => d.Roles)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "UserPermission",
                        l => l.HasOne<SoftwarePermission>().WithMany().HasForeignKey("RoleId"),
                        ...
                        j =>
                        {
                            ...
                            j.HasIndex(new[] { "RoleId" }, "IX_UserPermissions_RoleId");
                        });
            });
